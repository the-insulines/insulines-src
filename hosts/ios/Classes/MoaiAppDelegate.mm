...
@implementation MoaiAppDelegate
	...
	-( BOOL ) application:( UIApplication* )application didFinishLaunchingWithOptions:( NSDictionary* )launchOptions {
        ...
        // added to set landscape as default orientation
        CGRect viewBounds;
        viewBounds.origin.x = [ UIScreen mainScreen ].bounds.origin.y;
        viewBounds.origin.y = [ UIScreen mainScreen ].bounds.origin.x;
